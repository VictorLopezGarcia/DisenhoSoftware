...
class ReleaseTest {
    ...
    public void testToString() {
        ...
        String expectedString =
                """
                        Release ID: 8b53c32c-ee79-42b1-a7a9-bd7c63322c31
                        Artist: Madonna
                        Title: Angel (US 12" Single)
                        
                        Tracklist:
                        Track Number: A1
                        Track ID: 74e2ab8f-56f2-4b9c-ad35-336c73cd73e0
                        Track Artist: Madonna
                        Track Title: Angel (Extended Dance Mix)
                        Track Duration: 375

                        Track Number: B1
                        Track ID: 986645ce-32d0-42ba-999a-7faf2603aa7e
                        Track Artist: Madonna
                        Track Title: Into The Groove
                        Track Duration: 280

                        """;

        assertEquals(expectedString, madonnaAngelUSMaxiSingle.toString());
    }
